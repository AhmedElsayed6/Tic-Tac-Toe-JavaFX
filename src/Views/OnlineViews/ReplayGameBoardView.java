...
public class ReplayGameBoardView extends AnchorPane {
    ...
    public ReplayGameBoardView(String match) {
        ...
        imgViewBackGround.setLayoutY(-61.0);
        ...
        gameController = new GameReplayController( imageViewList , linesList , labelList , match);
    }
}
