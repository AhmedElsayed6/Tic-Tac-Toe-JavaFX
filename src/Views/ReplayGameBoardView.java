...
public class ReplayGameBoardView extends AnchorPane {
    ...
    GameReplayController gameController;
    List<VBox> vboxList ;
    List<Line> linesList;
    List<Label> labelList;
    List<ImageView> imageViewList;
    Player player1,player2;
    public ReplayGameBoardView(Player player1, Player player2) {
...
//
     ...
     //   gameController = new GameReplayController(imageViewList , linesList , labelList , player1 , player2);
    }
}
