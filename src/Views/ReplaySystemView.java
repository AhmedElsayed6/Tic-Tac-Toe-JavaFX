...
import Controllers.GameReplayController;
...
public class ReplaySystemView extends AnchorPane {
    ...
    GameReplayController  replayController;
    List<VBox> vboxList ;
    List<Line> linesList;
    List<Label> labelList;
    List<ImageView> imageViewList;
   
    public ReplaySystemView () {
...
//
        ...
        replayController = new GameReplayController(imageViewList , linesList , labelList );
    }
}
