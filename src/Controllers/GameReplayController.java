...
public class GameReplayController  {
    ...
    public GameReplayController(List<ImageView> imageViewList, List<Line> linesList, List<Label> labelList) {
        this.imageViewList = imageViewList;
        this.labelList = labelList;
        this.linesList = linesList;
                ReplaySystem.initReplaySystem(null);
        this.player1 = ReplaySystem.player1;
        this.player2 = ReplaySystem.player2;
   ...
   boolean check = true ;
    ...
    private void setImageViewHandlers() {
          ...
          index = row*3 + col;
            ...
            if (currentIteration < ReplaySystem.numOfMoves) {
                  String move = ReplaySystem.playMove() ;    
                     String [] locations  = move.split("[.]");
            
                  row  = Integer.valueOf(locations[0]);
          
                 col =   Integer.valueOf(locations[1]);
                 index = row*3+col; 
                ...
                // Stop timeline or perform any cleanup
                timeline.stop();
            }
        }));
        timeline.setCycleCount(NUM_ITERATIONS); // Number of iterations
        timeline.play();
